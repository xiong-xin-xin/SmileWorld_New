...
namespace DAL
{
    public interface IBaseDao
    {
        ...
        Task<int> DeleteByIdAsync<T>(string vue, IDbTransaction tran = null) where T : class, new();
        Task<int> DeleteAsync<T>(string vue, string key, IDbTransaction tran = null) where T : class, new();
        Task<int> DeleteAsync<T>(object where, IDbTransaction tran = null) where T : class, new();
